    ...
    <Fragment>
        <div className="col p-4"> 
            <div className="p-4 bg-dark slide-in-top">
                ...
                <div className="row">
                    <div className="col-6">
                        <h2 className="ff-jose fw-bold ls-2">Abinaya AkshithaS</h2>
                    </div>
                </div>
                <hr></hr>
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <ul>
                            <li>
                                ...
                                <h6 className="blue-label px-2 py-1">Nov 2021 - june 2025</h6>
                                <h5 className="m-0">Dr. Mahalingam College of Engineering and Technology
                                </h5>
